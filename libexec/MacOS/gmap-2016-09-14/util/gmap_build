...
my $gmapdb = "/Volumes/cluster/DistMap_v2.7.1/executables/gmap-2016-09-14/share";
my $package_version = "2016-09-14";
...
# Default values
my $bindir = "/Volumes/cluster/DistMap_v2.7.1/executables/gmap-2016-09-14/bin";   # dirname(__FILE__)
my $sampling = 3;
my $sleeptime = 2;
