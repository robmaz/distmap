...
if ($read_type1 =~ /(pe|pair)/i) {
	...
	#/Volumes/cluster/DistMap_v2.7.1/executables/ngm-0.4.13/ngm -b -r /Volumes/disk3/slaves-test/input/dmel_genome.fasta -1 /Volumes/disk3/slaves-test/input/read1_1M.fastq -2 /Volumes/disk3/slaves-test/input/read2_1M.fastq --sensitive -t 2 --local -o /Volumes/disk3/slaves-test/output/ngm_test1/ngm_mapres.bam
