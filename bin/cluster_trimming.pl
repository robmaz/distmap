...
if ( $read_type1 =~ /(pe|pair)/i ) {
    ...
    my $cmd = "";
    my $cmd1 =
"perl trim-fastq.pl $trim_args --disable-zipped-output --input1 $read1_fastq --input2 $read2_fastq --output1 $read1_fastq_out --output2 $read2_fastq_out --outputse $read_se_output > $std_output";
...
"perl trim-fastq.pl $trim_args --disable-zipped-output --input1 $read1_fastq --input2 $read2_fastq --output1 $read1_fastq_out --output2 $read2_fastq_out --outputse $read_se_output > $std_output";
    ...
    unless ( -e $trim_perl_script ) {
        $cmd =
"java -Xmx4g -jar $exe_path TrimFastq $trim_args --disable-zipped-output --input1 $read1_fastq --input2 $read2_fastq --number-of-thread 1 --output $trim_output_prefix";
    }

    print STDERR "cmd: $cmd\n";

    Utility::runCommand( $cmd,
        "perl trim-fastq.pl of $read1_fastq and $read2_fastq" ) == 0
      || die "Error perl trim-fastq.pl of $read1_fastq and $read2_fastq";
    ...
    my $cmd = "";
    my $cmd1 =
"perl trim-fastq.pl $trim_args --disable-zipped-output --input1 $read1_fastq --output1 $read1_fastq_out > $std_output";
...
"perl trim-fastq.pl $trim_args --disable-zipped-output --input1 $read1_fastq --output1 $read1_fastq_out > $std_output";
    ...
    unless ( -e $trim_perl_script ) {
        $cmd =
"java -Xmx4g -jar $exe_path TrimFastq $trim_args --disable-zipped-output --input1 $read1_fastq --number-of-thread 1 --output $trim_output_prefix";
    }

    Utility::runCommand( $cmd, "perl trim-fastq.pl of $read1_fastq" ) == 0
      || die "Error perl trim-fastq.pl of $read1_fastq";
