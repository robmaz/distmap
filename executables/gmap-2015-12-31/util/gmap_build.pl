...
my $gmapdb = "/Volumes/cluster/DistMap_v2.7.1/executables/gmap-2015-12-31/share";
my $package_version = "2015-12-31";
...
# Default values
my $bindir = "/Volumes/cluster/DistMap_v2.7.1/executables/gmap-2015-12-31/bin";   # dirname(__FILE__)
my $sampling = 3;
my $sleeptime = 2;
